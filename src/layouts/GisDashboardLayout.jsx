  ...
  return (
    <div className="flex">
      ...
      <div className="fixed top-0 left-0 w-[18%] h-screen border-r-2 border-[#b8b9ba] p-5 flex flex-col gap-5 bg-white z-50">
        ...
        {/* Menu Items */}
      <div className="flex items-center gap-3 cursor-pointer" onClick={()=>navigate('/gis/dashboard')}>
        <img src={DashboardIcon} alt="Dashboard icon" className="w-5 h-5" />
        <p className="text-[14px] font-medium text-[#344054]">Dashboard</p>
      </div>

      <div className="flex items-center gap-3 cursor-pointer" onClick={()=>navigate('/gis/role-base-access')}>
        <img src={DashboardIcon} alt="Dashboard icon" className="w-5 h-5" />
      ...
      <div className="flex items-center gap-3 cursor-pointer" onClick={()=>navigate('/gis/factorylist')}>

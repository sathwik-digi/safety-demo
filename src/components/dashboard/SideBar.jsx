  ...
  return (
    <div className="flex">
      ...
      <div className="fixed top-0 left-0 w-[18%] h-screen border-r-2 border-[#b8b9ba] p-5 flex flex-col gap-5 bg-white z-50">
        ...
        {/* Menu Items */}
      <div className="flex items-center gap-3 cursor-pointer" onClick={() => setDisplayCount(0)}>
      ...
      <div className="flex items-center gap-3 cursor-pointer" onClick={() => setDisplayCount(5)}>
      ...
      <div className="flex items-center justify-between cursor-pointer">
        <div className="flex items-center gap-3" onClick={() => setDisplayCount(0)}>
